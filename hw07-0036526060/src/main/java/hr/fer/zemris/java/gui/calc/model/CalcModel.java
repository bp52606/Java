...
public interface CalcModel {
	...
	/**
	 * Method that sets given value as frozen, that is, calculated.
	 * 
	 * @param value given value to be set as frozen.
	 *
	 */
	...
	/**
	 * Function returning information about calculator having frozen a value or not.
	 * 
	 * @return true if calculator has frozen value, false otherwise
	 */
